...
**                           - Originally, when CTRL-D was pressed twice after some characters were already entered 
**                             it simulate an end of file, but I changed it to behave like Jae's.
...
==26093== Copyright (C) 2002-2011, and GNU GPL'd, by Julian Seward et al.
==26093== Using Valgrind-3.7.0 and LibVEX; rerun with -h for copyright info
==26093== Command: ./mdb-lookup my-mdb
==26093== 
...
lookup : ==26093== 
==26093== HEAP SUMMARY:
==26093==     in use at exit: 0 bytes in 0 blocks
==26093==   total heap usage: 8 allocs, 8 frees, 776 bytes allocated
==26093== 
==26093== All heap blocks were freed -- no leaks are possible
==26093== 
==26093== For counts of detected and suppressed errors, rerun with: -v
==26093== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 2 from 2)
